...
class TruncLcgRand(Rng):
  ...
  def __init__(self, output_size: int):
    ...
    REF_MULTIPLIERS = {
      ...
      # 256-bit multiplier is generated by using accompanying code for the paper:
      # Steele, G.L.; Vigna, S. Computationally Easy, Spectrally Good Multipliers
      # for Congruential Pseudorandom Number Generators. Softw Pract Exp 2022,
      # 52, 443–458, doi:10.1002/spe.3030.
  ...
  def RandomBits(self, n: int, *, seed: Optional[int] = None) -> int:
    ...
    for j in range(num_outputs):
      ...
      ba[output_size_bytes * j:output_size_bytes * (j + 1)] = output.to_bytes(output_size_bytes, "little")
